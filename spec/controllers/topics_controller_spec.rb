...
#---> PROBLEM STARTED HERE! I refactored to include an explicit reference to 'params'
      it "increases the number of topics by 1" do
        #Watch for blanks. If you write 'expect {post...' instead of 'expect{ post...' it won't work!
