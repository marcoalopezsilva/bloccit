...
RSpec.describe TopicsController, type: :controller do
  ...
  context "guest" do
    ...
    #If the user is a guest, we should allow him to see things
    ...
    # But, we shoudl not be allowing guest users to post anything new (redirect to new_session_path)
     describe "GET new" do
...
#-------
  ...
  # Context moderator user ends here
  # ---------------
